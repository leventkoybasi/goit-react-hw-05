    ...
    <>
      <div className='container my-5'>
        ...
        <div className='card mb-4'>
          ...
          <div className='card-body'>
            ...
            <div className='form-check form-switch mt-3'>
              <input className='form-check-input' type='checkbox' id='autoplayToggle' />
            ...
            <div className='form-check form-switch mt-3'>
              <input className='form-check-input' type='checkbox' id='emailNotificationsToggle' />
              <label className='form-check-label' htmlFor='emailNotificationsToggle'>
                Email Notifications
              </label>
            </div>
          </div>
        ...
        <div className='card mb-4'>
          ...
          <div className='card-body'>
            <div className='form-check form-switch'>
              <input className='form-check-input' type='checkbox' id='publicProfileToggle' />
            ...
            <div className='form-check form-switch mt-3'>
              <input className='form-check-input' type='checkbox' id='watchHistoryToggle' />
